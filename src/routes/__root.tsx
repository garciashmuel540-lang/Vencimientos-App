  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Control de vencimientos para tiendas de conveniencia. Escanea, registra y recibe avisos antes de que un producto caduque.",
      },
      { name: "theme-color", content: "#23483c" },
